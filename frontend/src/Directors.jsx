...
const DirectorsSection = () => {
  ...
  const directors = [
    {
      id: 1,
      name: "Mr. Krishan K. Doda",
      title: "CEO & Founder",
      description:
        "Krishan K. Doda, a visionary leader with over 25 years of experience in pharmaceutical innovation, founded Suave Healthcare with a mission to make quality healthcare accessible to all. As the Chief Executive Officer, Mr. Doda focuses on strategic planning, research & development, and ensuring the highest standards of pharmaceutical excellence. His leadership and pioneering insights have been instrumental in establishing Suave Healthcare as a trusted name in the industry, while maintaining our commitment to integrity and patient-centric care.",
    ...
    },
    {
      ...
      description:
        "Usha Doda brings over 20 years of expertise in pharmaceutical research and product development to Suave Healthcare. With a Ph.D. in Pharmaceutical Sciences from IIT Delhi, she leads our R&D initiatives and ensures that all our products meet international quality standards. Her innovative approach to drug formulation and her commitment to scientific excellence have resulted in numerous breakthrough products that have transformed patient care across various therapeutic segments.",
  ...
  return (
    <div className="md:max-w-[75vw] mx-auto px-6 py-12 prevent-select">
      ...
      <div
        ...
        className="cursor-grab overflow-x-auto custom-scrollbar pb-4"
      >
